...
const priceList = [
  ...
  { key: "5000000", label: "Dưới 5 triệu" },
  { key: "10000000", label: "5 triệu đến 10 triệu" },
  { key: "15000000", label: "Trên 10 triệu" },
];
...
export default function TabletContainer() {
  ...
  if (watchedPrice === "5000000") {
    maxPrice = 5000000;
  } else if (watchedPrice === "10000000") {
    minPrice = 5000000;
    maxPrice = 10000000;
  } else if (watchedPrice === "15000000") {
    minPrice = 10000000;
  }
